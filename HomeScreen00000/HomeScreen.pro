QT += quick multimedia dbus xml quickcontrols2  # add thêm quickcontrols2
CONFIG += c++11
...
## Sử dụng thư viện cài vào máy: sudo apt-get install libtag1-dev
LIBS += -ltag

## Sử dụng thư viện được đính kèm project
